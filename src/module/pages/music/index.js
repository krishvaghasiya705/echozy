        ...
        <div className="player-bar">
          <div className="player-left">
            ...
            <div className="player-info">
              <h4 className="player-title">{currentSong.song}</h4>
              <p className="player-artists">{currentSong.primary_artists}</p>
            </div>
          </div>
          <div className="player-center">
            <div className="player-controls">
              <button className="control-button"><BiShuffle size={20} /></button>
              <button className="control-button"><BsSkipStartFill size={24} /></button>
              <button className="control-button play-button" onClick={togglePlay}>
                {isPlaying ? <BsPauseFill size={30} /> : <BsPlayFill size={30} />}
              </button>
              <button className="control-button"><BsSkipEndFill size={24} /></button>
              <button className="control-button"><BiRepeat size={20} /></button>
            </div>
